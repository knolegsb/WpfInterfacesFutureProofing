...
namespace PeopleViewer
{
    ...
    {
        public object Convert(object value, Type tagetType, object parameter, System.Globalization.CultureInfo culture)
        {
            int year = ((DateTime)value).Year;
            return string.Format("{0}0s", year.ToString().Substring(0, 3));
        }
        public object ConvertBack(object vlaue, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
